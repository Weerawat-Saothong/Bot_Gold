...
# [OK] กรณีที่ 1: signal = "NONE" → ไม่ควรเรียก AI
...
print(f"   [OK] Result: {result_none['provider']} (confidence: {result_none['confidence']}%)\n")

# [OK] กรณีที่ 2: signal = "BUY" → ควรเรียก AI
...
print(f"   [OK] Result: {result_buy['provider']} (confidence: {result_buy['confidence']}%)\n")

# [OK] กรณีที่ 3: signal = "SELL" → ควรเรียก AI
...
print(f"   [OK] Result: {result_sell['provider']} (confidence: {result_sell['confidence']}%)\n")

print("[OK] Test complete! AI only called on BUY/SELL signals.")